...
export default function ConfirmEmail() {
  return (
    <div className="flex flex-col items-center sm:items-start max-h-96 max-w-md">
      <Image className="max-w-48 max-h-48 mx-auto" src={confirmEmail} alt="Caixa de Cartas" />
      <h1 className="my-4 primary-title">Confirme seu e-mail</h1>
      <span className="text-center sm:text-start text-gray-600">
